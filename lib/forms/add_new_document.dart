...
class NewFileDocument extends StatefulWidget {
  ...
  @override
  State<NewFileDocument> createState() => _NewFileDocumentState();
}

class _NewFileDocumentState extends State<NewFileDocument> {
  @override
          ...
          children: [
            Padding(
              ...
              child: secondaryScreenHeader(
                context: context,
                screenTitle: "Add Document To File",
              ),
            ),
            Expanded(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    largeSizeUploadButton(
                      buttonPurpose: "Upload Document To File",
                      context: context,
                      onTapLargeButton: () async {
                        await CoolAlert.show(
                          ...
                          text: "Uploading document to client file...",
